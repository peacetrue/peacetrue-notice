...
@ImportAutoConfiguration(classes = {
        TestServiceNoticeAutoConfiguration.class,
        WebMvcAutoConfiguration.class,
        HttpMessageConvertersAutoConfiguration.class,
        ControllerNoticeAutoConfiguration.class,
        SpringDataWebAutoConfiguration.class,
})
@EnableAutoConfiguration
@ActiveProfiles("notice-controller-test")
public class TestControllerNoticeAutoConfiguration {
